...
module.exports = {
	entry: {
		...
		teacherClassRooms:
			componentEnrtryPrefix + 'TeacherClassRoomsNew/teacherClassRoomsNew.js',
		...
		teacherFeedbackDetail:
			componentEnrtryPrefix +
			'TeacherFeedbackDetail/teacherFeedbackDetailNew.js',
		...
		feedback: componentEnrtryPrefix + 'FeedbackNew/FeedbackNew.js',
