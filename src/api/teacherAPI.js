...
export const getTeacherListEvaluation = async (params = {}) => {
	let result;
	try {
...
export const getTeacherFeedbackDetail = async (params = {}) => {
	let result;
	try {
		let res = await instance.get(
			path + `/GetEvaluation?BookingID=${params.BookingID}`,
		);
		result = res.data;
	} catch (error) {
		return error.message ? error.message : (result = '');
...
export const getAddEvaluation = async (params = {}) => {
	let result;
	try {
		let res = await instance.get(
			path +
...
export const getUpdateEvaluation = async (params = {}) => {
	let result;
	try {
		let res = await instance.get(
			path +
...
export const getClassHistory = async (params = {}) => {
	let result;
	try {
		let res = await instance.get(path + '/GetLessionHistoryTeacher', {
			params: {
				...params,
				UID: appSettings.UID,
			},
...
export const getSalaryTeacher = async (params = {}) => {
	let result;
	try {
		let res = await instance.get(path + '/GetHistorySalaryOrder', {
			params: {
				...params,
				UID: appSettings.UID,
			},
