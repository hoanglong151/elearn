										...
										{loading ? (
											...
											state.UpcomingLessions.map(item => (
												<LessonUpcomingCard
													...
													start={
														convertDateFromTo(item.ScheduleTimeVN).fromTime
													}
													...
													LinkMaterials={item.LinkMaterials}
