		...
		<form onSubmit={_handleSubmit}>
			<div className="content-block">
				<div className="mg-b-30">
					<h5 className="">
						<i className="fas fa-info-circle mg-r-5"></i>Summary
					</h5>
				...
				<div className="mg-b-30">
					<h5 className="">
						<i className="fab fa-youtube mg-r-5"></i>Introduction video
					</h5>
					<p className="tx-gray-500">
						...
						<div className="input-group mg-t-15 mg-b-15">
							...
							<div className="input-group-append">
								<button
									...
									onClick={showGuide}
								>
									<i className="far fa-question-circle mg-r-5"></i> How to get
									iframe url
								</button>
							</div>
						</div>
