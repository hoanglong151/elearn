				...
				<div className="media-body mg-l-20 pos-relative">
					<div>
						...
						{SpecialRequest && (
							<div className="course-note mg-t-15">
								<h6 className="mg-b-3 tx-bold">{t('noteteacher')}:</h6>
						...
						{!!DocumentName && (
							<div className="course-docs mg-t-15">
								...
								<div>
									{' '}
									<a href={LessionMaterial} rel="noreferrer" target="_blank">
										{DocumentName}
									</a>
								</div>
							</div>
						...
						{!!FileAudio && (
							<div className="course-docs mg-t-15">
								...
								<div>
									{' '}
									<a href={FileAudio} rel="noreferrer" target="_blank">
										Download
									</a>
								</div>
							</div>
						...
						{!!FileAudio1 && (
							<div className="course-docs mg-t-15">
								...
								<div>
									{' '}
									<a href={FileAudio1} rel="noreferrer" target="_blank">
										Download
									</a>
								</div>
							</div>
						...
						{!!FileAudio2 && (
							<div className="course-docs mg-t-15">
								...
								<div>
									{' '}
									<a href={FileAudio2} rel="noreferrer" target="_blank">
										Download
									</a>
								</div>
							</div>
						...
						{!!LinkMaterials && (
							<div className="course-docs mg-t-15">
								<h6 className="mg-b-3 tx-bold">Link Materials :</h6>
								<div>
									{' '}
									<a href={LinkMaterials} rel="noreferrer" target="_blank">
										View
									</a>
								</div>
							</div>
					...
					<div className="course-actions mg-t-15">
						<div className="action-left">
							...
							>
								<div>
									<i className="fab fa-skype mg-r-5"></i>
									{t('joinclass-1')}
								</div>
							</a>
							<a
							...
							>
								<i className="fas fa-edit mg-r-5"></i>
								{t('note-1')}
							</a>
						</div>
						<div className="action-right">
							{cancelable ? (
								<a
									...
									rel="noopener"
									data-toggle="tooltip"
									title="Bạn chỉ có thể hủy lớp 60 phút trước khi vào học !!"
									onClick={e =>
										handleCancelBooking(
											e,
											BookingID,
